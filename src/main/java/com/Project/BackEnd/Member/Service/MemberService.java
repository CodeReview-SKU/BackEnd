...
public class MemberService {
    ...
    public void create(String userId, String password, String name) {
    ...
    public loginInfo login(String userId, String password) throws Exception {
        ...
        Member member = memberRepository.findByUserId(userId).orElseThrow(() -> new UsernameNotFoundException("사용자를 찾을 수 없습니다."));
